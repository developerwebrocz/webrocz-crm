...
export default async function StaffLoginPage({ searchParams }: PageProps<"/staff">) {
  // Bounce only when a REAL user is signed in (DB-checked) — prevents the redirect loop.
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)] px-4 py-10">
      <div className="w-full max-w-[400px]">
        ...
        <div className="mt-4 text-center text-[11px] font-bold uppercase tracking-[0.18em] text-[var(--violet)]">Team Portal</div>
        ...
        <div className="card mt-4 p-7 sm:p-8" style={{ boxShadow: "var(--shadow-md)" }}>
          <LoginForm
            ...
            subtitle="For Account Managers, SEO, Design & Video teams."
          />
        </div>
